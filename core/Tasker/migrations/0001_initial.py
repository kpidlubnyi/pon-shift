    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('route_type', models.IntegerField(choices=[(0, 'Metro And Tram'), (3, 'Bus')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stop_lat', models.DecimalField(decimal_places=6, max_digits=8)),
                ('stop_lon', models.DecimalField(decimal_places=6, max_digits=8)),
                ('location_type', models.IntegerField(choices=[(0, 'Bus'), (2, 'Metro')])),

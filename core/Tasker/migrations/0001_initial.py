# Generated by Django 5.2.5 on 2025-09-23 17:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('carrier', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Tasker.carrier')),
                ('from_stop', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transfers_from', to='Tasker.stop')),
                ('to_stop', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transfers_to', to='Tasker.stop')),
                ('from_trip', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transfers_from', to='Tasker.trip')),
                ('to_trip', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transfers_to', to='Tasker.trip')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transfer_type', models.IntegerField(choices=[(1, 'One')])),
                ('carrier', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Tasker.carrierstaging')),
                ('from_stop', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transfers_staging_from', to='Tasker.stopstaging')),
                ('to_stop', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transfers_staging_to', to='Tasker.stopstaging')),
                ('from_trip', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transfers_staging_from', to='Tasker.tripstaging')),
                ('to_trip', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transfers_staging_to', to='Tasker.tripstaging')),
            ],
            options={
